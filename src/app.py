...
activities.update({
    "Basketball Club": {
        "description": "Join competitive and pickup basketball games, learn teamwork and skills",
    ...
    "Drama Society": {
        "description": "Acting workshops, stage production and annual plays",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions across biology, physics and engineering",
